...
export class UserService {
  ...
  getAll() {
    return this.angularFirestore.collection<User>(this.collectionName, ref => ref.orderBy('name', 'desc')).valueChanges();
  }
  ...
  getByEmail(email: string) {
    return this.angularFirestore.collection<User>(this.collectionName, ref => ref.where('email', '==', email).orderBy('email')).valueChanges();
  } 
}
